const Footer = ({urls}: {
    urls?: IProfileLinks
}) => <footer className="flex text-center justify-center space-x-3 pt-24 pb-8">
    <a href={urls?.linkedin}>
        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 fill-current text-green-600" viewBox="0 0 24 24">
