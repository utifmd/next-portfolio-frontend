...
export default function (
    ...
    const screenshots: TImageLightBox[] = typeof experience.imageUrls !== "undefined"
                ...
                <div className="border-t dark:border-gray-600 border-gray-300">
                    <dl>
                        ...
                        <div
                            ...
                            <dd className="mt-1 text-sm sm:mt-0 sm:col-span-2 uppercase">{experience.platform} {experience.type}</dd>
                        </div>
